    ...
    def self.available_options
      ...
      [
        ...
        FastlaneCore::ConfigItem.new(key: :custom_product_page_id,
                                     ...
                                     optional: true),
        FastlaneCore::ConfigItem.new(key: :custom_product_page_version_id,
                                     env_name: "DELIVER_CUSTOM_PRODUCT_PAGE_VERSION_ID",
                                     description: "Optional: Specific Custom Product Page Version ID to target (must be editable, e.g. DRAFT or PREPARE_FOR_SUBMISSION)",
                                     optional: true),
