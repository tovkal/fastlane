  ...
  class Runner
    ...
    def upload_metadata
      ...
      if options[:custom_product_page_id]
        cpp_options = options.dup
        if options[:custom_product_page_screenshots_path]
          cpp_options[:screenshots_path] = options[:custom_product_page_screenshots_path]
        end

        cpp_upload = UploadCustomProductPageScreenshots.new
        cpp_screenshots = cpp_upload.collect_screenshots(cpp_options)
        cpp_upload.upload(cpp_options, cpp_screenshots)
